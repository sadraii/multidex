...
public class EntryDao extends AbstractDao<Entry, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property LabelId = new Property(3, Long.class, "labelId", false, "LABEL_ID");
    };
    ...
    public Entry readEntity(Cursor cursor, int offset) {
        Entry entity = new Entry( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3) // labelId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Entry entity, int offset) {
        ...
        entity.setLabelId(cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3));
     }
