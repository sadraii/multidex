...
public class ColorCodeDao extends AbstractDao<ColorCode, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Argb = new Property(2, String.class, "argb", false, "ARGB");
        public final static Property Task = new Property(3, String.class, "task", false, "TASK");
    };
    ...
    protected void bindValues(SQLiteStatement stmt, ColorCode entity) {
        ...
        if (argb != null) {
            stmt.bindString(3, argb);
        }
 
        String task = entity.getTask();
        if (task != null) {
            stmt.bindString(4, task);
        }
    }
    ...
    public ColorCode readEntity(Cursor cursor, int offset) {
        ColorCode entity = new ColorCode( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // argb
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // task
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, ColorCode entity, int offset) {
        ...
        entity.setArgb(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setTask(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
     }
